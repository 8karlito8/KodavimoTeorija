...
function App() {
  ...
  return (
    <div className="app">
      {/* Header section: Displays the app title and description */}
      <header className="app-header">
        <h1>React Learning Examples</h1>
        <p>Learn Props, State, Hooks, and API Calls</p>
      </header>

      {/* Navigation section: Buttons to switch between examples */}
      <nav className="app-nav">
        {/* Loop through examples and create a button for each */}
      ...
      {/* Main content: Renders the currently selected example component */}
      <main className="app-main">
        <CurrentComponent />
      </main>

      {/* Footer section: Instructions for the user */}
      <footer className="app-footer">
        <p>
          Read the code in <code>src/examples/</code> to understand each concept
        </p>
        <p>
